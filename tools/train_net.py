...
from ss_recon.engine import DefaultTrainer, GreedyTrainer, AsyncGreedyTrainer, MELTrainer, default_argument_parser, default_setup
...
def main(args):
    ...
    if cfg.MODEL.TRAIN_MODE == "Standard":
        trainer = DefaultTrainer(cfg)
    elif cfg.MODEL.TRAIN_MODE == "DGL":
        trainer = GreedyTrainer(cfg)
    elif cfg.MODEL.TRAIN_MODE == "ADGL":
        trainer = AsyncGreedyTrainer(cfg)
    elif cfg.MODEL.TRAIN_MODE == "MEL":
        trainer = MELTrainer(cfg)
    elif cfg.MODEL.TRAIN_MODE == "GRADCP":
        trainer = MELTrainer(cfg)
