...
from ss_recon.engine import SimpleTrainer, MELSimpleTrainer, hooks
...
class MELTrainer(MELSimpleTrainer):
    """
    A trainer with MEL training logic. Compared to `SimpleTrainer`, it
    ...
    def __init__(self, cfg):
        ...
        #optimizer = self.build_optimizer(cfg, model.modl.network)
